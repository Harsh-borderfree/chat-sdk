...
var ChatOptions = function (props) {
    ...
    var _j = useState(null), anchorElMenu = _j[0], setAnchorElMenu = _j[1];
    var _k = useState(false), showBlockOption = _k[0], setShowBlockOption = _k[1];
    var isAllowed = props.isAllowed, Permissions = props.Permissions, eventID = props.eventID, groupID = props.groupID;
    var _l = useState(false), showMenuItem = _l[0], setShowMenuItem = _l[1];
    ...
    var _m = useState({}), selectedMessage = _m[0], setSelectedMessage = _m[1];
    var alreadyBlockedEmail = ((_e = (_d = currentEvent === null || currentEvent === void 0 ? void 0 : currentEvent.chat_info) === null || _d === void 0 ? void 0 : _d.blocked_Email) === null || _e === void 0 ? void 0 : _e.length) > 0 ? __spreadArray([], (_f = currentEvent === null || currentEvent === void 0 ? void 0 : currentEvent.chat_info) === null || _f === void 0 ? void 0 : _f.blocked_Email, true) : [];
    ...
    var unPinMessages = function () {
        setShowMenuItem(false);
        var unPinId = selectedMessage === null || selectedMessage === void 0 ? void 0 : selectedMessage.id;
    ...
    var onBlockClick = function () {
        var _a, _b, _c;
        setShowMenuItem(false);
        var userMsgData = selectedMessage === null || selectedMessage === void 0 ? void 0 : selectedMessage.sender_id;
        ...
        var data = {
            event_id: eventID,
            data: __assign(__assign({}, currentEvent === null || currentEvent === void 0 ? void 0 : currentEvent.chat_info), { blocked_Email: alreadyBlockedEmail }),
            event_type: 'chat_info',
        };
        global.sdk.SetEventLevelData(data, function () { }, function (res) {
            console.log('failed to update destinations', res);
        ...
        global.sdk.UpdateShowJson({
            id: eventID,
            data: {
                chat_info: __assign(__assign({}, currentEvent === null || currentEvent === void 0 ? void 0 : currentEvent.chat_info), { blocked_Email: alreadyBlockedEmail }),
            },
        }, function () { }, function (e) {
            console.log('error update', e);
        });
    };
    var onUnblockClick = function () {
        var _a, _b, _c;
        setShowMenuItem(false);
        var userMsgData = selectedMessage === null || selectedMessage === void 0 ? void 0 : selectedMessage.sender_id;
        var alreadyBlockedEmail = ((_b = (_a = currentEvent === null || currentEvent === void 0 ? void 0 : currentEvent.chat_info) === null || _a === void 0 ? void 0 : _a.blocked_Email) === null || _b === void 0 ? void 0 : _b.length) > 0 ? __spreadArray([], (_c = currentEvent === null || currentEvent === void 0 ? void 0 : currentEvent.chat_info) === null || _c === void 0 ? void 0 : _c.blocked_Email, true) : [];
        var presentIndex = checkForBlockEmail(userMsgData, currentEvent);
        var newBlockedArray = __spreadArray([], alreadyBlockedEmail, true);
        if (presentIndex >= 0) {
            newBlockedArray.splice(presentIndex, 1);
        }
        var data = {
            event_id: eventID,
            data: __assign(__assign({}, currentEvent === null || currentEvent === void 0 ? void 0 : currentEvent.chat_info), { blocked_Email: newBlockedArray }),
            event_type: 'chat_info',
        };
        global.sdk.SetEventLevelData(data, function () { }, function (res) {
            console.log('failed to update destinations', res);
        ...
        global.sdk.UpdateShowJson({
            id: eventID,
            data: {
                chat_info: __assign(__assign({}, currentEvent === null || currentEvent === void 0 ? void 0 : currentEvent.chat_info), { blocked_Email: newBlockedArray }),
            },
        }, function () { }, function (e) {
            console.log('error update', e);
        });
    ...
    return (_jsxs(_Fragment, { children: [_jsx(IconButton, __assign({ ref: anchorRef, id: 'simple-menu', className: 'rce-mbox-title-right', style: { cursor: 'pointer' }, onClick: function (e) {
                ...
                (window.innerWidth > 1024 ? (_jsxs(Menu, __assign({ open: true, id: 'simple-menu', anchorEl: anchorRef.current, keepMounted: true, onClose: function () {
                        ...
                        vertical: 'top',
                        horizontal: 'right',
                    } }, { children: [_jsx(MenuItem, __assign({ xid: '4O', onClick: function () {
                                setShowMenuItem(false);
                                props.setShowReplyPopup(true);
                                props.setRepliedMessageData(selectedMessage);
                            }, className: 'RCChat-menu-pin' }, { children: t('watch.reply') })), isAllowed(permissions, Permissions.chat_admin_msg_pin.index) &&
                            ((adminPinnedMessages === null || adminPinnedMessages === void 0 ? void 0 : adminPinnedMessages.find(function (pinEl) { return (pinEl === null || pinEl === void 0 ? void 0 : pinEl.message_id) === (selectedMessage === null || selectedMessage === void 0 ? void 0 : selectedMessage.id); })) ? (_jsx(MenuItem, __assign({ xid: '4P', onClick: function () {
                                    unPinMessages();
                            ...
                            checkForBlockEmail(message === null || message === void 0 ? void 0 : message.sender_id, currentEvent) < 0 &&
                            showBlockOption && (_jsx(MenuItem, __assign({ xid: '4R', onClick: onBlockClick, className: 'RCChat-menu-pin' }, { children: t('watch.block_user') }))), isAllowed(permissions, Permissions.chat_admin_msg_block.index) &&
                            checkForBlockEmail(message === null || message === void 0 ? void 0 : message.sender_id, currentEvent) >= 0 &&
                            showBlockOption && (_jsx(MenuItem, __assign({ xid: '4S', onClick: onUnblockClick, className: 'RCChat-menu-pin' }, { children: t('watch.unblock_user') })))] }))) : (_jsxs(SwipeableDrawer, __assign({ anchor: 'bottom', transitionDuration: 400, open: Boolean(anchorElMenu), PaperProps: {
                        square: false,
                        style: {
                            ...
                            overflowX: 'hidden',
                                ...
                                border: '1px solid',
                                        ...
                                        cursor: 'pointer',
                                                ...
                                                color: 'var(--brand-color)',
                                                marginRight: '13px',
                                            } }), checkForBlockEmail((_g = props === null || props === void 0 ? void 0 : props.mesagesData) === null || _g === void 0 ? void 0 : _g.sender_id, currentEvent) < 0 && showBlockOption && (_jsx(Typography, __assign({ variant: 'h6', style: {
                                                fontSize: '16px',
                                                color: 'var(--text-color)',
                                                fontWeight: '400',
                                            }, xid: '4R' }, { children: t('watch.block_user') }))), checkForBlockEmail((_h = props === null || props === void 0 ? void 0 : props.mesagesData) === null || _h === void 0 ? void 0 : _h.sender_id, currentEvent) >= 0 && showBlockOption && (_jsx(Typography, __assign({ variant: 'h6', style: {
                                                fontSize: '16px',
                                                color: 'var(--text-color)',
                                                fontWeight: '400',
