...
var ChatTextMesage = function (props) {
    ...
    return (_jsxs("div", __assign({ className: 'box' }, { children: [isLinkInMessage && metaData && _jsx(ChatLinkMessages, { metaData: metaData, openLink: openLink }), _jsx("div", __assign({ className: 'MuiTypography-subtitle2 text-message-div' }, { children: (_a = newLineHandler(message === null || message === void 0 ? void 0 : message.message_text)) === null || _a === void 0 ? void 0 : _a.map(function (elem) {
                    return (_jsx(_Fragment, { children: isUrl(elem) ? (_jsx(_Fragment, { children: elem.split(' ').map(function (s) {
                                return (_jsx(_Fragment, { children: isUrl(s) ? (_jsxs("a", __assign({ onClick: openLink, className: 'text-message-link' }, { children: [s, "\u00A0"] }))) : (_jsx(_Fragment, { children: s != '' && (_jsxs("p", __assign({ style: {
                                                display: 'inline-block',
                                                margin: '0px 0px',
                                            }, className: 'MuiTypography-subtitle2 text-message-content' }, { children: [s, "\u00A0"] }))) })) }));
                            }) })) : (_jsx(_Fragment, { children: elem != '' && _jsx("p", __assign({ className: 'MuiTypography-subtitle2 text-message-content' }, { children: elem })) })) }));
                }) }))] })));
};
