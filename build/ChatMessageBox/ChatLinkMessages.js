...
var ChatLinkMessages = function (_a) {
    ...
    return (_jsxs("div", __assign({ className: 'upper' }, { children: [(metaData === null || metaData === void 0 ? void 0 : metaData.image) && (_jsx("div", __assign({ className: 'upperLeft' }, { children: _jsx("div", __assign({ "data-testid": 'container', onClick: openLink }, { children: _jsx("div", { "data-testid": 'image-container', style: {
