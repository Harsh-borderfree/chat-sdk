...
const PinnedLinkMessage = ({ metaData, openLink }) => {
  ...
  return (
    <div className='upper-pin'>
      {metaData?.image && (
        <div className='upperLeft-pin'>
          <div classNam='Container-pin' data-testid='container' onClick={openLink}>
            <div
      ...
      <div className='upperRight-pin'>
        <div className='titleContainer-pin'>
          {metaData?.title && (
            <h5
              data-testid='title'
              className='Title-pin'
        ...
        <div className='Secondary SiteDetails-pin'>
          {metaData?.siteName && (
            <>
